...
html[${S}]:not([${D}]) [data-pane='conversation'] > div[${_}],
html[${S}]:not([${D}]) [class*='centerCol'] > div[${_}] {
  display: flex !important; flex-direction: column;
}
html[${S}]:not([${D}]) [data-pane='conversation'] > :not([${_}]),
html[${S}]:not([${D}]) [class*='centerCol'] > :not([${_}]) {
