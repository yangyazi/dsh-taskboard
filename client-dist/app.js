(()=>{(()=>{if(window.__dshTaskboardLoaded)return;window.__dshTaskboardLoaded=!0;let Mt="/taskboard/api",x={todo:{label:"\u5F85\u529E",color:"#8b949e"},in_progress:{label:"\u8FDB\u884C\u4E2D",color:"#3478f6"},in_review:{label:"\u8BC4\u5BA1\u4E2D",color:"#bc8cff"},blocked:{label:"\u5DF2\u963B\u585E",color:"#f85149"},done:{label:"\u5DF2\u5B8C\u6210",color:"#3fb950"}},P=["todo","in_progress","in_review","blocked","done"],N={low:{label:"\u4F4E",color:"#8b949e"},medium:{label:"\u4E2D",color:"#d29922"},high:{label:"\u9AD8",color:"#e3862e"},urgent:{label:"\u7D27\u6025",color:"#f85149"}},st={none:"\u2014",pending:"\u8BC4\u5BA1\u5F85\u5904\u7406",approved:"\u8BC4\u5BA1\u901A\u8FC7",rejected:"\u8BC4\u5BA1\u9A73\u56DE"},at={none:"\u2014",pending:"\u6D4B\u8BD5\u5F85\u5904\u7406",passed:"\u6D4B\u8BD5\u901A\u8FC7",failed:"\u6D4B\u8BD5\u5931\u8D25"},pt=["#79c0ff","#d2a8ff","#7ee787","#ffa657","#ff7b72","#f2cc60","#a5d6ff","#ffd7a8"],z="data-dsh-taskboard-active",A="data-dsh-taskboard-entry",_="data-dsh-taskboard-view",Y="data-dsh-ssh-active",It='<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="2.5" width="12" height="11" rx="1.5"/><path d="M2 6.5h12M6.5 6.5v7"/></svg>',o=(t,e=document)=>e.querySelector(t),y=(t,e=document)=>[...e.querySelectorAll(t)],l=t=>String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]),H=t=>{let e=String(t||"").split("/").filter(Boolean);return e.length?e[e.length-1]:String(t||"")},_t=t=>{let e=0;for(let s of String(t))e=e*31+s.charCodeAt(0)>>>0;return pt[e%pt.length]},R=t=>{if(!t)return"";let e=new Date(t),s=Date.now()-t;return s<6e4?"\u521A\u521A":s<36e5?`${Math.floor(s/6e4)} \u5206\u949F\u524D`:s<864e5?`${Math.floor(s/36e5)} \u5C0F\u65F6\u524D`:`${e.getMonth()+1}/${e.getDate()} ${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`},j=[],M=[],D=[],ot=[],C={q:"",repo:"",priority:"",status:"",label:""},O="overview",X={};async function g(t,e={}){let s=await fetch(Mt+t,{headers:{"content-type":"application/json"},...e}),a=await s.json().catch(()=>({}));if(!s.ok)throw new Error(a.error||`HTTP ${s.status}`);return a}let Ot=`
<style>
...
</style>`;document.documentElement.insertAdjacentHTML("beforeend",Ot);let Pt=`
<div id="dsh-tb-view" ${_}="">
  ...
  <div class="dsh-tb-body" id="dsh-tb-body"></div>
</div>`;function ht(){let t=document.querySelector('[data-pane="sidebar"], [class*="sidebarCol"]');return t===null?void 0:t.querySelector('[class*="logoRow"]')?.parentElement??t.firstElementChild}function ft(t){let e=t.querySelector('button[class*="newSession"]');if(e!==null)return e;for(let s of t.children)if(s.tagName==="BUTTON")return s}function ut(){return document.querySelector('[data-pane="conversation"]')??document.querySelector('[class*="centerCol"]')??void 0}function vt(t){return[...t.classList].some(e=>/collapsed/i.test(e))}let w=null,V=null;function W(){return document.documentElement.hasAttribute(z)}function gt(){w!==null&&(W()?w.setAttribute("data-active",""):w.removeAttribute("data-active"))}function K(t){let e=t!==void 0?t:!W();e&&document.documentElement.removeAttribute(Y),e?document.documentElement.setAttribute(z,""):document.documentElement.removeAttribute(z),gt(),e&&F()}function xt(){if(V!==null)return;let t=ut();t!==void 0&&(V=document.createElement("div"),V.setAttribute(_,""),V.innerHTML=Pt,t.appendChild(V),Yt())}function mt(){let t=ht();if(t===void 0||(w===null&&(w=document.createElement("button"),w.type="button",w.setAttribute(A,""),w.innerHTML=`<span>${It}</span><span>\u4EFB\u52A1\u770B\u677F</span>`,w.title="\u4EFB\u52A1\u770B\u677F",w.addEventListener("click",()=>K()),gt()),w.parentElement===t))return;let e=ft(t),s=e?.closest('[class*="logoRow"]'),a=s!=null&&s.parentElement===t?s:e;t.insertBefore(w,a?.nextElementSibling??null),(()=>{w!==null&&(vt(t)?w.setAttribute("data-icon-only",""):w.removeAttribute("data-icon-only"))})()}let Nt=15,m=null,S=null,q=!1,wt=null;function B(t){let e=String(t??"");return e&&!e.startsWith("session-")?`session-${e}`:e}function nt(t){return(t||[]).map(e=>e&&e.id&&B(e.id)!==e.id?{...e,id:B(e.id)}:e)}function Ht(){return g("/sessions").then(t=>nt(t.sessions||[])).catch(()=>M)}function it(t){return t.title&&String(t.title).trim()?String(t.title).trim():String(t.id)}function Rt(t){return String(t).replace(/^session-/,"").slice(0,8)}function Dt(t){let e=new Set,s=[];for(let a of[...t||[]].filter(d=>d&&d.updatedAt).sort((d,r)=>(r.updatedAt||0)-(d.updatedAt||0)))if(!e.has(a.id)&&!(a.empty===!0||it(a)===String(a.id))&&(e.add(a.id),s.push(a),s.length>=Nt))break;return s}function yt(t){return`dsh-tb-read:${t}`}function qt(t){try{return Number(localStorage.getItem(yt(t)))||0}catch{return 0}}function Bt(t){try{localStorage.setItem(yt(t),String(Date.now()))}catch{}}function rt(t){if(S===null)return;let e=Dt(t),s=o("#dsh-recent-cnt");if(s&&(s.textContent=String(e.length)),!e.length){S.innerHTML='<div class="dsh-recent-empty">\uFF08\u6682\u65E0\u6700\u8FD1\u4F1A\u8BDD\uFF09</div>';return}let a=Q(),d=new Map;for(let r of e){let c=it(r);d.set(c,(d.get(c)||0)+1)}S.innerHTML=e.map(r=>{let c=it(r),u=(d.get(c)||0)>1,b=r.id===a,h="";return r.running?h='<span class="dot run"></span>':r.updatedAt&&r.updatedAt>qt(r.id)&&(h='<span class="dot idle"></span>'),`<div class="dsh-recent-row${b?" cur":""}" data-sid="${l(r.id)}" title="\u6253\u5F00\u5E76\u7EE7\u7EED\uFF1A${l(c)}\uFF08${l(r.id)}\uFF09">
				<span class="slot">${h}</span>
				<span class="title">${l(c)}</span>
				${u?`<span class="sid">${l(Rt(r.id))}</span>`:""}
				<span class="time">${R(r.updatedAt)}</span>
			</div>`}).join(""),y(".dsh-recent-row",S).forEach(r=>r.addEventListener("click",()=>{Z(r.dataset.sid)}))}function G(){Ht().then(t=>rt(t)).catch(()=>rt(M))}function kt(){let t=ht();if(t===void 0||(m===null&&(m=document.createElement("div"),m.id="dsh-recent",m.className="dsh-recent",m.innerHTML=`
				...
				<div class="dsh-recent-body" id="dsh-recent-body"></div>`,S=o("#dsh-recent-body",m),o("#dsh-recent-head",m).addEventListener("click",()=>{q=!q,m&&m.classList.toggle("collapsed",q),S&&(S.style.display=q?"none":"")}),o("#dsh-recent-refresh",m).addEventListener("click",d=>{d.stopPropagation(),G()}),rt(M),G()),m.parentElement===t))return;let e=w??ft(t);t.insertBefore(m,e?.nextElementSibling??null),S&&(S.style.maxHeight="46vh",S.style.overflowY="auto"),(()=>{S&&(S.style.display=q?"none":""),m&&m.classList.toggle("collapsed",q)})(),(()=>{m&&(vt(t)?m.style.display="none":m.style.display="")})()}function Jt(){wt===null&&(wt=setInterval(()=>{document.hidden||G()},6e4))}function Yt(){o("#dsh-tb-new")?.addEventListener("click",zt),o("#dsh-tb-refresh")?.addEventListener("click",()=>F()),o("#dsh-tb-search")?.addEventListener("input",()=>{C.q=o("#dsh-tb-search").value.trim(),k()}),o("#dsh-tb-repo-filter")?.addEventListener("change",()=>{C.repo=o("#dsh-tb-repo-filter").value,k()}),o("#dsh-tb-priority-filter")?.addEventListener("change",()=>{C.priority=o("#dsh-tb-priority-filter").value,k()}),o("#dsh-tb-status-filter")?.addEventListener("change",()=>{C.status=o("#dsh-tb-status-filter").value,k()}),o("#dsh-tb-label-filter")?.addEventListener("change",()=>{C.label=o("#dsh-tb-label-filter").value,k()}),y(".dsh-tb-tab").forEach(t=>t.addEventListener("click",()=>{O=t.dataset.tbView,tt()}))}async function k(){let t=new URLSearchParams;for(let s of["q","repo","priority","status","label"])C[s]&&t.set(s,C[s]);j=(await g(`/tasks?${t}`)).tasks||[],tt()}async function Vt(){try{let[t,e]=await Promise.all([g("/sessions"),g("/workspaces")]);M=nt(t.sessions||[]),D=e.workspaces||[];let s=o("#dsh-tb-repo-filter");if(s){let b=s.value;s.innerHTML='<option value="">\u5168\u90E8\u4ED3\u5E93</option>'+D.map(h=>`<option value="${l(h.path)}" title="${l(h.path)}">${l(H(h.path))}</option>`).join(""),b&&[...s.options].some(h=>h.value===b)&&(s.value=b)}let a=await g("/tasks").catch(()=>({tasks:[]})),d=new Set;for(let b of a.tasks||[])for(let h of b.labels||[])d.add(h);ot=[...d].sort();let r=o("#dsh-tb-label-filter");if(r){let b=r.value;r.innerHTML='<option value="">\u5168\u90E8\u6807\u7B7E</option>'+ot.map(h=>`<option value="${l(h)}">${l(h)}</option>`).join(""),b&&[...r.options].some(h=>h.value===b)&&(r.value=b)}let c=o("#dsh-tb-priority-filter");c&&!c.options.length&&(c.innerHTML='<option value="">\u5168\u90E8\u4F18\u5148\u7EA7</option>'+Object.entries(N).map(([b,h])=>`<option value="${b}">${h.label}</option>`).join(""));let u=o("#dsh-tb-status-filter");u&&!u.options.length&&(u.innerHTML='<option value="">\u5168\u90E8\u72B6\u6001</option>'+Object.entries(x).map(([b,h])=>`<option value="${b}">${h.label}</option>`).join(""))}catch{}}async function Wt(){for(let t of D)if(!(!t.path||X[t.path]!==void 0))try{let e=await fetch(`/ide/api/git?op=status&path=${encodeURIComponent(t.path)}`).then(s=>s.json());X[t.path]=e.git?{branch:e.branch?.name||"(detached)",dirty:(e.files||[]).length}:null}catch{X[t.path]=null}}function F(){return Vt().then(()=>Wt()).then(k).catch(k)}function $t(t){return(t.labels||[]).map(e=>`<span class="dsh-tb-pill" style="color:${_t(e)}">${l(e)}</span>`).join("")}function Kt(t){let e=x[t.status]||x.todo;return`<span class="dsh-tb-pill" style="color:${e.color}">${e.label}</span>`}function Et(t){let e=N[t.priority]||N.medium;return`<span class="dsh-tb-pill" style="color:${e.color}">${e.label}</span>`}function Ft(t){let e=(s,a,d)=>`<button type="button" class="dsh-tb-statusbtn ${d||""}" data-status="${s}">${a}</button>`;switch(t.status){case"todo":return`${e("in_progress","\u25B6 \u5F00\u59CB\u6267\u884C")} ${e("blocked","\u26D4 \u963B\u585E","ghost")}`;case"in_progress":return`${e("in_review","\u63D0\u4EA4\u8BC4\u5BA1")} ${e("blocked","\u26D4 \u963B\u585E","ghost")}`;case"in_review":return`${e("done","\u2705 \u786E\u8BA4\u5B8C\u6210","primary")} ${e("in_progress","\u21A9 \u9000\u56DE\u4FEE\u6539")}`;case"done":return`${e("in_progress","\u21A9 \u91CD\u65B0\u6253\u5F00","ghost")}`;case"blocked":return`${e("in_progress","\u25B6 \u6062\u590D\u8FDB\u884C")}`;default:return""}}let dt=null,St=0,Ut=5e3;function Xt(){let t=new Set,e=document.querySelectorAll('[class*="centerCol"], [class*="sidebarCol"], [class*="frame"], [class*="App"], body > div');for(let s of e){for(let a of Object.keys(s)){if(!a.startsWith("__reactFiber$")&&!a.startsWith("__reactContainer$"))continue;let d=s[a];for(;d&&d.return;)d=d.return;d&&t.add(d)}if(t.size>0)break}return[...t]}function Lt(){let t=Date.now();if(dt!==null&&t-St<Ut)return dt;let e={open:null,startSession:null},s=Xt(),a=0,d=t+40;for(;s.length>0&&a++<4e4&&!((a&255)===0&&Date.now()>d);){let r=s.shift(),c=r.memoizedProps;if(c!==null&&typeof c=="object"){e.open===null&&typeof c.open=="function"&&(e.open=c.open),e.startSession===null&&typeof c.startSession=="function"&&(e.startSession=c.startSession);let u=c.sessions??c.sessionService;if(u!==null&&typeof u=="object"&&(e.open===null&&typeof u.open=="function"&&(e.open=u.open),e.startSession===null&&typeof u.start=="function"&&(e.startSession=u.start)),e.open!==null&&e.startSession!==null)break}r.child&&s.push(r.child),r.sibling&&s.push(r.sibling)}return dt=e,St=Date.now(),e}function Gt(){return Lt().open}function Q(){try{let t=localStorage.getItem("dsh.sessions.current");if(t===null)return null;let e=JSON.parse(t);return typeof e?.sessionId=="string"?e.sessionId:null}catch{return null}}function Tt(){let t=[...document.querySelectorAll('[class*="_handle"], [class*="handle"]')].find(b=>b.offsetParent!==null&&getComputedStyle(b).cursor==="col-resize");if(!t)return!1;let e=t.getBoundingClientRect(),s=Math.round(e.left+e.width/2),a=Math.round(e.top+Math.min(200,e.height/2)),d=Element.prototype,r=d.setPointerCapture,c=d.hasPointerCapture,u=d.releasePointerCapture;try{d.setPointerCapture=function(){},d.hasPointerCapture=function(){return!0},d.releasePointerCapture=function(){};let b=(h,n)=>new PointerEvent(h,{bubbles:!0,cancelable:!0,composed:!0,pointerId:1,pointerType:"mouse",isPrimary:!0,buttons:1,clientX:n,clientY:a});return t.dispatchEvent(b("pointerdown",s)),t.dispatchEvent(b("pointermove",s+1)),t.dispatchEvent(b("pointerup",s+1)),!0}catch{return!1}finally{d.setPointerCapture=r,d.hasPointerCapture=c,d.releasePointerCapture=u}}function Z(t){t=B(t),Bt(t);try{let e=Gt();if(typeof e=="function"){try{localStorage.setItem("dsh.sessions.current",JSON.stringify({sessionId:t}))}catch{}e(t),W()&&K(!1),y(".dsh-tb-modal-mask").forEach(s=>s.remove()),G();return}}catch{}try{localStorage.setItem("dsh.sessions.current",JSON.stringify({sessionId:t})),localStorage.setItem("dsh-taskboard.unstick",String(Date.now()))}catch{}location.reload()}async function Ct(t){let e=Q(),s=new Set;try{s=new Set((await g("/sessions")).sessions.map(a=>B(a.id)))}catch{}if(Qt())return W()&&K(!1),y(".dsh-tb-modal-mask").forEach(a=>a.remove()),Zt(t),L("\u5DF2\u8FDB\u5165\u65B0\u5BF9\u8BDD\uFF1A\u53D1\u9001\u7B2C\u4E00\u6761\u6D88\u606F\u540E\u81EA\u52A8\u7ED1\u5B9A\u5230\u8BE5\u4EFB\u52A1"),te(t,e,s),!0;try{let{sessionId:a}=await g(`/tasks/${t}/session`,{method:"POST",body:"{}"});return ee("\u2713 \u5DF2\u65B0\u5EFA\u5BF9\u8BDD\u5E76\u7ED1\u5B9A\u5230\u8BE5\u4EFB\u52A1"),Z(a),!0}catch(a){return alert(`\u65B0\u5EFA\u5BF9\u8BDD\u5931\u8D25\uFF1A${a.message}`),!1}}function Qt(){let t=document.querySelector('button[class*="newSession"]');if(t!==null)return t.click(),!0;let e=Lt();if(typeof e.startSession=="function")try{return e.startSession(),!0}catch{}return!1}function Zt(t){g(`/tasks/${t}/context`).then(e=>{let s=e?.context;if(!(typeof s!="string"||!s))return navigator.clipboard?.writeText?.(s)}).catch(()=>{})}function te(t,e,s){let a=Date.now()+18e5,d=setInterval(async()=>{let r=Q();if(r!==null&&r!==e&&!s.has(r)){clearInterval(d);try{await g(`/tasks/${t}/sessions`,{method:"POST",body:JSON.stringify({sessionId:r,action:"link"})}),L("\u2713 \u5DF2\u628A\u65B0\u5BF9\u8BDD\u7ED1\u5B9A\u5230\u8BE5\u4EFB\u52A1"),k()}catch{}return}Date.now()>a&&clearInterval(d)},1e3)}function ee(t){try{localStorage.setItem("dsh-taskboard.pending-toast",t)}catch{}}function L(t){let e=document.createElement("div");e.className="dsh-tb-toast",e.textContent=t,document.body.appendChild(e),setTimeout(()=>e.remove(),1600)}function se(){var v;let t={};for(let i of P)t[i]=0;let e={};for(let i of j){t[i.status]!==void 0&&t[i.status]++;let f=i.repo||"\uFF08\u672A\u6307\u5B9A\uFF09";(e[f]||(e[f]=[])).push(i)}let s=j.length,a=t.done||0,d=s?Math.round(a/s*100):0,r={};for(let i of M)i.repo&&(r[v=i.repo]||(r[v]=[])).push(i);let c=[...j].sort((i,f)=>f.updatedAt-i.updatedAt).slice(0,10),b='<div class="dsh-tb-ov-stat dsh-tb-ov-add" id="dsh-tb-ov-new" title="\u65B0\u5EFA\u4EFB\u52A1"><div class="dsh-tb-ov-addbtn">\uFF0B \u65B0\u5EFA\u4EFB\u52A1</div></div>'+[["\u5168\u90E8\u4EFB\u52A1",s,"#e6edf3",""],...P.map(i=>[x[i].label,t[i]||0,x[i].color,i]),["\u5B8C\u6210\u7387",`${d}%`,"#3fb950",null]].map(([i,f,E,$])=>{let ct=i==="\u5B8C\u6210\u7387"?d:s?Math.round(f/s*100):0,et=$!==null?" dsh-tb-ov-stat-click":"",bt=$===""?"\u67E5\u770B\u5168\u90E8\u4EFB\u52A1":$?`\u67E5\u770B\u300C${i}\u300D\u7684\u4EFB\u52A1`:"";return`<div class="dsh-tb-ov-stat${et}" ${$!==null?`data-status="${$}"`:""} title="${bt}"><div class="n" style="color:${E}">${f}</div><div class="l">${i}</div><div class="mini"><i style="width:${ct}%;background:${E}"></i></div></div>`}).join(""),h;D.length?h=D.map(i=>{let f=e[i.path]||e[i.title]||[],E=P.map(T=>f.filter(I=>I.status===T).length),$=f.length,ct=E[P.indexOf("done")]||0,et=$?Math.round(ct/$*100):0,bt=$?P.map((T,I)=>E[I]?`<i style="width:${Math.round(E[I]/$*100)}%;background:${x[T].color}" title="${x[T].label} ${E[I]}"></i>`:"").join(""):"",le=P.map((T,I)=>E[I]?`<span class="st"><i class="dot" style="background:${x[T].color}"></i>${x[T].label} <b>${E[I]}</b></span>`:"").join(""),ce=(r[i.path]||r[i.title]||[]).length,U=X[i.path],be=U?`<span class="branch">\u2387 ${l(U.branch)}</span>${U.dirty?`<span class="branch dirty" title="${U.dirty} \u4E2A\u672A\u63D0\u4EA4\u6587\u4EF6">\u25CF${U.dirty}</span>`:""}`:"",At=(r[i.path]||r[i.title]||[]).slice(0,3).map(T=>`<div class="s" data-sid="${l(T.id)}" title="\u6253\u5F00\u4F1A\u8BDD ${l(T.id)}">\u25B8 ${l(T.title)}</div>`).join("");return`<div class="dsh-tb-ov-ws" data-repo="${l(i.path)}">
					<div class="ws-head"><h4>${l(i.title)}</h4><span class="ws-total">${$} \u4E2A\u4EFB\u52A1</span></div>
					<div class="path">${l(i.path||"")}</div>
					${$?`<div class="stack">${bt}</div><div class="ws-stats">${le}</div>`:'<div class="ws-stats" style="color:var(--dsw-alias-label-secondary,#9aa7b4)">\u6682\u65E0\u4EFB\u52A1\uFF0C\u70B9\u300C\uFF0B \u65B0\u5EFA\u300D\u521B\u5EFA</div>'}
					<div class="comp"><span class="pct">\u5B8C\u6210\u7387 ${et}%</span><div class="track"><i style="width:${et}%"></i></div></div>
					<div class="meta">${be}<span class="sess">\u4F1A\u8BDD ${ce}</span></div>
					${At?`<div class="sesslist">${At}</div>`:""}
				</div>`}).join(""):h='<div class="dsh-tb-empty">\uFF08\u6682\u65E0\u5DE5\u4F5C\u533A\uFF09</div>';let n=c.length?c.map(i=>{let f=x[i.status]||x.todo;return`<div class="dsh-tb-ov-item" data-id="${l(i.id)}">
				<span class="dot" style="background:${f.color}"></span>
				<span class="t">${l(i.title)}</span>
				${i.repo?`<span class="r">${l(H(i.repo))}</span>`:""}
				<span class="tm">${R(i.updatedAt)}</span>
		...
		</div>`,o("#dsh-tb-ov-new")?.addEventListener("click",zt),y(".dsh-tb-ov-stat[data-status]").forEach(i=>i.addEventListener("click",()=>{C.status=i.dataset.status,O="list",tt(),k()})),y(".dsh-tb-ov-ws").forEach(i=>i.addEventListener("click",()=>{C.repo=i.dataset.repo;let f=o("#dsh-tb-repo-filter");f&&(f.value=C.repo),O="kanban",tt(),k()})),y(".dsh-tb-ov-ws .s").forEach(i=>i.addEventListener("click",f=>{f.stopPropagation(),Z(i.dataset.sid)})),y(".dsh-tb-ov-item").forEach(i=>i.addEventListener("click",()=>{i.dataset.id&&J(i.dataset.id)})))}function ae(t){let e=x[t.status]||x.todo,s=N[t.priority]||N.medium,a=[];a.push(Et(t)),t.status==="in_review"&&a.push('<span class="dsh-tb-pill" style="color:#bc8cff;font-weight:600">\u25C9 \u5F85 review</span>'),t.repo&&a.push(`<span class="dsh-tb-pill" style="color:#79c0ff">${l(H(t.repo))}</span>`),t.feature&&a.push(`<span class="dsh-tb-pill" style="color:#d2a8ff">${l(t.feature)}</span>`),a.push($t(t)),t.review&&t.review!=="none"&&a.push(`<span class="dsh-tb-pill" style="color:${t.review==="approved"?"#3fb950":t.review==="rejected"?"#f85149":"#d29922"}">${st[t.review]}</span>`),t.test&&t.test!=="none"&&a.push(`<span class="dsh-tb-pill" style="color:${t.test==="passed"?"#3fb950":t.test==="failed"?"#f85149":"#d29922"}">${at[t.test]}</span>`);let d=[];return t.sessionIds?.length&&d.push(`<span>\u4F1A\u8BDD ${t.sessionIds.length}</span>`),t.notes?.length&&d.push(`<span>\u8BC4\u8BBA ${t.notes.length}</span>`),d.push(`<span>${R(t.updatedAt)}</span>`),`<div class="dsh-tb-card" data-id="${l(t.id)}" style="border-left:3px solid ${e.color}">
		...
		</div>`}function oe(){let t=o("#dsh-tb-body"),e=o("#dsh-tb-count");if(!t)return;t.innerHTML='<div class="dsh-tb-columns"></div>';let s=o(".dsh-tb-columns",t);e&&(e.textContent=`${j.length} \u4E2A\u4EFB\u52A1`);for(let[a,d]of Object.entries(x)){let r=document.createElement("div");r.className="dsh-tb-col";let c=j.filter(b=>b.status===a);r.innerHTML=`<div class="dsh-tb-col-head">${d.label} <b>${c.length}</b></div><div class="dsh-tb-col-body"></div>`;let u=o(".dsh-tb-col-body",r);c.length?c.forEach(b=>u.insertAdjacentHTML("beforeend",ae(b))):u.innerHTML='<div class="dsh-tb-empty">\u2014</div>',s.appendChild(r)}y(".dsh-tb-card",s).forEach(a=>a.addEventListener("click",()=>J(a.dataset.id)))}function ne(){let t=o("#dsh-tb-body"),e=o("#dsh-tb-count");if(!t)return;if(e&&(e.textContent=`${j.length} \u4E2A\u4EFB\u52A1`),!j.length){t.innerHTML='<div class="dsh-tb-ov"><div class="dsh-tb-empty">\uFF08\u6682\u65E0\u4EFB\u52A1\uFF0C\u70B9\u300C\uFF0B \u65B0\u5EFA\u300D\u521B\u5EFA\uFF09</div></div>';return}let s=j.map(a=>`<tr data-id="${l(a.id)}">
			<td>${Kt(a)}</td>
			<td>${Et(a)}</td>
		...
		</div>`,y("tr[data-id]",t).forEach(a=>a.addEventListener("click",()=>J(a.dataset.id)))}function tt(){y(".dsh-tb-tab").forEach(e=>{e.dataset.tbView===O?e.classList.add("dsh-tb-tab-on"):e.classList.remove("dsh-tb-tab-on")});let t=o("#dsh-tb-toolbar");t&&(t.style.display=O==="overview"?"none":"flex"),O==="kanban"?oe():O==="list"?ne():se()}function zt(){let t=document.createElement("div");t.className="dsh-tb-modal-mask";let e=D.map(c=>`<option value="${l(c.path)}" title="${l(c.path)}">${l(c.path)}</option>`).join(""),s=(c,u)=>{o(c,t)?.classList.add("err"),u&&(o(u,t).hidden=!1)},a=()=>{t.innerHTML=`<div class="dsh-tb-modal" style="width:min(560px,92vw)">
				<h3>\u65B0\u5EFA\u4EFB\u52A1</h3>
			...
			</div>`,o("#tb-f-title",t).addEventListener("input",()=>{o("#tb-f-title",t).classList.remove("err"),o("#tb-hint-title",t).hidden=!0}),o("#tb-f-repo",t).addEventListener("change",()=>{o("#tb-f-repo",t).classList.remove("err"),o("#tb-hint-repo",t).hidden=!0}),o('[data-act="cancel"]',t).addEventListener("click",r),o('[data-act="save"]',t).addEventListener("click",async()=>{let c=o("#tb-f-title",t).value.trim(),u=o("#tb-f-repo",t).value;o("#tb-hint-title",t).hidden=!0,o("#tb-hint-repo",t).hidden=!0,y(".err",t).forEach(h=>h.classList.remove("err"));let b=!0;if(c||(s("#tb-f-title","#tb-hint-title"),b=!1),u||(s("#tb-f-repo","#tb-hint-repo"),b=!1),!!b)try{let{task:h}=await g("/tasks",{method:"POST",body:JSON.stringify({title:c,repo:u,feature:o("#tb-f-feature",t).value.trim(),description:o("#tb-f-desc",t).value})});F(),d(h)}catch(h){alert(`\u521B\u5EFA\u5931\u8D25\uFF1A${h.message}`)}}),o("#tb-f-title",t).focus()},d=c=>{t.innerHTML=`<div class="dsh-tb-modal" style="width:min(560px,92vw)">
				<h3>\u2705 \u4EFB\u52A1\u5DF2\u521B\u5EFA</h3>
			...
			</div>`,o('[data-act="newsess"]',t).addEventListener("click",async()=>{t.remove(),await Ct(c.id)}),o('[data-act="bind"]',t).addEventListener("click",()=>{t.remove(),J(c.id)}),o('[data-act="detail"]',t).addEventListener("click",()=>{t.remove(),J(c.id)}),o('[data-act="close"]',t).addEventListener("click",()=>t.remove())},r=()=>t.remove();t.addEventListener("click",c=>{c.target===t&&r()}),document.body.appendChild(t),a()}function ie(t,e){g("/sessions").then(s=>{let a=document.createElement("div");a.className="dsh-tb-modal-mask",a.innerHTML=`<div class="dsh-tb-modal" style="width:min(600px,92vw)">
				<h3>\u9009\u62E9\u4F1A\u8BDD\u5173\u8054</h3>
			...
			</div>`,document.body.appendChild(a);let d=nt(s.sessions||M),r=o("#tb-pick-list",a),c=u=>{let b=String(u||"").trim().toLowerCase(),h=d.filter(v=>!b||String(v.title||"").toLowerCase().includes(b)),n={};for(let v of h){let i=v.repo||"\uFF08\u672A\u6307\u5B9A\uFF09";(n[i]||(n[i]=[])).push(v)}let p=Object.entries(n).sort((v,i)=>i[1].length-v[1].length).map(([v,i])=>(i.sort((f,E)=>(E.updatedAt||0)-(f.updatedAt||0)),`<div class="dsh-tb-pick-group">
							<div class="dsh-tb-pick-grouphead">${l(H(v))} <b>${i.length}</b></div>
							${i.map(f=>`<div class="dsh-tb-pick-item" data-sid="${l(f.id)}">
								<div class="t">${l(f.title||f.id)}${f.running?' <span class="dsh-tb-run">\u25CF \u8FD0\u884C\u4E2D</span>':""}</div>
								<div class="m">${f.updatedAt?R(f.updatedAt):""}</div>
							</div>`).join("")}
						</div>`)).join("");r.innerHTML=p||'<div class="dsh-tb-empty">\uFF08\u65E0\u5339\u914D\u4F1A\u8BDD\uFF09</div>',y(".dsh-tb-pick-item",a).forEach(v=>v.addEventListener("click",async()=>{let i=v.dataset.sid;try{let{task:f,injected:E,injectionNote:$}=await g(`/tasks/${t}/sessions`,{method:"POST",body:JSON.stringify({sessionId:i,action:"link"})});a.remove(),await k(),e(f),L(E===!0?"\u2713 \u5DF2\u5173\u8054\u4F1A\u8BDD":$||"\u5DF2\u5173\u8054\u4F1A\u8BDD")}catch(f){alert(`\u5173\u8054\u5931\u8D25\uFF1A${f.message}`)}}))};c(""),o("#tb-pick-search",a).addEventListener("input",()=>c(o("#tb-pick-search",a).value)),o('[data-act="cancel"]',a).addEventListener("click",()=>a.remove()),a.addEventListener("click",u=>{u.target===a&&a.remove()}),o("#tb-pick-search",a).focus()}).catch(()=>alert("\u83B7\u53D6\u4F1A\u8BDD\u5217\u8868\u5931\u8D25"))}async function J(t){let{task:e}=await g(`/tasks/${t}`);lt(e)}function lt(t){let e=t.id,s=document.createElement("div");s.className="dsh-tb-modal-mask";let a=M.map(n=>`<option value="${l(n.id)}">${l(n.title||n.id)}${n.repo?` \xB7 ${l(H(n.repo))}`:""}</option>`).join("");s.innerHTML=`<div class="dsh-tb-modal" style="width:min(700px,92vw)">
			<h3>${l(t.title)}</h3>
			...
			<div class="dsh-tb-row">
				<div class="dsh-tb-field"><label>\u72B6\u6001\uFF08AI \u81EA\u52A8\u6D41\u8F6C\uFF0C\u4F60\u53EA\u9700\u5728"\u8BC4\u5BA1\u4E2D"\u65F6\u5904\u7406\uFF09</label>
					<div class="dsh-tb-statusline">
						...
						<div class="dsh-tb-statusactions">${Ft(t)}</div>
					</div>
				</div>
				<div class="dsh-tb-field"><label>\u4F18\u5148\u7EA7</label><select id="tb-d-priority">${Object.entries(N).map(([n,p])=>`<option value="${n}" ${n===t.priority?"selected":""}>${p.label}</option>`).join("")}</select></div>
			...
			<div class="dsh-tb-row">
				<div class="dsh-tb-field"><label>Review</label><select id="tb-d-review">${Object.entries(st).map(([n,p])=>`<option value="${n}" ${n===t.review?"selected":""}>${p}</option>`).join("")}</select></div>
				<div class="dsh-tb-field"><label>\u6D4B\u8BD5</label><select id="tb-d-test">${Object.entries(at).map(([n,p])=>`<option value="${n}" ${n===t.test?"selected":""}>${p}</option>`).join("")}</select></div>
				<div class="dsh-tb-field"><label>\u6807\u7B7E</label><input id="tb-d-labels" value="${l((t.labels||[]).join(", "))}" placeholder="\u9017\u53F7\u5206\u9694" list="tb-labels-datalist2" /><datalist id="tb-labels-datalist2">${ot.map(n=>`<option value="${l(n)}"></option>`).join("")}</datalist></div>
			</div>
			...
			<div class="dsh-tb-field"><label>\u8FDB\u5C55\u8BB0\u5F55\uFF08${(t.notes||[]).length}\uFF09</label>
				<div id="tb-d-notes">${(t.notes||[]).map(n=>`<div class="dsh-tb-note"><span class="dsh-tb-note-time">${R(n.at)}</span><br/>${l(n.text)}</div>`).join("")||'<div class="dsh-tb-note">\uFF08\u6682\u65E0\u8BB0\u5F55\uFF09</div>'}</div>
			...
			<div class="dsh-tb-field"><label>\u6C60\u5185\u4F1A\u8BDD\uFF08\u5171\u4EAB\u4E0A\u4E0B\u6587\u53EF\u8BBF\u95EE\u8005\uFF1B\u70B9\u51FB\u6253\u5F00\u53EF\u7EE7\u7EED\uFF09</label>
				<div id="tb-d-sessions">${(t.sessionIds||[]).map(n=>{let p=B(n),v=M.find(f=>f.id===p),i=v?l(v.title||p):'<span class="dsh-tb-sess-gone">\uFF08\u4F1A\u8BDD\u5DF2\u4E0D\u5B58\u5728\uFF09</span>';return`<div class="dsh-tb-sess"><span class="dsh-tb-sess-title" title="${l(p)}">${i}${v&&v.running?' <span class="dsh-tb-run">\u25CF \u8FD0\u884C\u4E2D</span>':""}</span>${v?`<button data-sid="${l(p)}" data-act="open" class="dsh-tb-open">\u6253\u5F00</button>`:""}<button data-sid="${l(n)}" data-act="unlink">\u89E3\u9664</button></div>`}).join("")||'<div class="dsh-tb-note">\uFF08\u672A\u5173\u8054\u4F1A\u8BDD\uFF09</div>'}</div>
		...
		</div>`,document.body.appendChild(s);let d=async()=>{let n=o("#tb-d-ctx-body",s);if(n)try{let{context:p}=await g(`/tasks/${e}/context`);n.textContent=p||"\uFF08\u6682\u65E0\u5171\u4EAB\u4E0A\u4E0B\u6587\uFF09"}catch{n.textContent="\uFF08\u83B7\u53D6\u5931\u8D25\uFF09"}},r=async()=>{try{let{context:n}=await g(`/tasks/${e}/context`);await navigator.clipboard.writeText(n||""),L("\u2713 \u5DF2\u590D\u5236\u6700\u65B0\u5171\u4EAB\u4E0A\u4E0B\u6587")}catch{try{let{context:n}=await g(`/tasks/${e}/context`),p=document.createElement("textarea");p.value=n||"",document.body.appendChild(p),p.select(),document.execCommand("copy"),p.remove(),L("\u2713 \u5DF2\u590D\u5236\u6700\u65B0\u5171\u4EAB\u4E0A\u4E0B\u6587")}catch(n){alert(`\u590D\u5236\u5931\u8D25\uFF1A${n.message}`)}}};d(),o("#tb-d-ctx-refresh",s)?.addEventListener("click",d),o("#tb-d-ctx-copy",s)?.addEventListener("click",r);let c=()=>({repo:o("#tb-d-repo",s).value.trim(),feature:o("#tb-d-feature",s).value.trim(),priority:o("#tb-d-priority",s).value,progress:Number(o("#tb-d-progress",s).value),review:o("#tb-d-review",s).value,test:o("#tb-d-test",s).value,labels:o("#tb-d-labels",s).value.split(",").map(n=>n.trim()).filter(Boolean),description:o("#tb-d-desc",s).value}),u=()=>s.remove(),b=n=>{s.remove(),lt(n)},h=async n=>{let{task:p}=await g(`/tasks/${e}`,{method:"PATCH",body:JSON.stringify(n)});return await k(),p};s.addEventListener("click",n=>{n.target===s&&u()}),o('[data-act="cancel"]',s).addEventListener("click",u),o('[data-act="save"]',s).addEventListener("click",async()=>{try{let n=await h(c());b(n),L("\u2713 \u5DF2\u4FDD\u5B58")}catch(n){alert(`\u4FDD\u5B58\u5931\u8D25\uFF1A${n.message}`)}}),o('[data-act="del"]',s).addEventListener("click",async()=>{if(confirm(`\u5220\u9664\u4EFB\u52A1\u300C${t.title}\u300D\uFF1F`))try{await g(`/tasks/${e}`,{method:"DELETE"}),u(),await F()}catch(n){alert(`\u5220\u9664\u5931\u8D25\uFF1A${n.message}`)}}),o('[data-act="copyctx"]',s)?.addEventListener("click",r),o("#tb-d-note",s).addEventListener("keydown",async n=>{if(n.key==="Enter"&&(n.ctrlKey||n.metaKey)){let p=o("#tb-d-note",s).value.trim();if(!p)return;try{let{task:v}=await g(`/tasks/${e}/notes`,{method:"POST",body:JSON.stringify({text:p})});await k(),b(v),L("\u2713 \u8FDB\u5C55\u5DF2\u8BB0\u5F55")}catch(v){alert(`\u8BB0\u5F55\u5931\u8D25\uFF1A${v.message}`)}}}),o("#tb-d-sess-open",s)?.addEventListener("click",()=>{ie(e,n=>{s.remove(),lt(n)})}),y("#tb-d-sessions [data-act]",s).forEach(n=>n.addEventListener("click",async()=>{let p=n.dataset.sid;if(n.dataset.act==="open")Z(p);else{let{task:v}=await g(`/tasks/${e}/sessions`,{method:"POST",body:JSON.stringify({sessionId:p,action:"unlink"})});await k(),b(v),L("\u5DF2\u89E3\u9664\u4F1A\u8BDD")}})),o("#tb-d-sess-new",s)?.addEventListener("click",async()=>{await Ct(e)}),y(".dsh-tb-statusbtn",s).forEach(n=>n.addEventListener("click",async()=>{try{let p=await h({status:n.dataset.status});b(p),L("\u2713 \u72B6\u6001\u5DF2\u66F4\u65B0")}catch(p){alert(`\u72B6\u6001\u6D41\u8F6C\u5931\u8D25\uFF1A${p.message}`)}})),o('[data-act="split"]',s)?.addEventListener("click",()=>{let n=document.createElement("div");n.className="dsh-tb-modal-mask",n.innerHTML=`<div class="dsh-tb-modal">
			...
			</div>`,document.body.appendChild(n);let p=()=>n.remove();o('[data-act="cancel"]',n).addEventListener("click",p),n.addEventListener("click",v=>{v.target===n&&p()}),o('[data-act="do"]',n).addEventListener("click",async()=>{let v=o("#tb-split-titles",n).value.split(`
`).map(i=>i.trim()).filter(Boolean);if(!v.length){o("#tb-split-titles",n).focus();return}try{let{tasks:i}=await g(`/tasks/${e}/split`,{method:"POST",body:JSON.stringify({titles:v})});p(),await F(),L(`\u2713 \u5DF2\u62C6\u5206\u4E3A ${i.length} \u4E2A\u5B50\u4EFB\u52A1`),i?.[0]&&J(i[0].id)}catch(i){alert(`\u62C6\u5206\u5931\u8D25\uFF1A${i.message}`)}}),o("#tb-split-titles",n).focus()})}xt(),mt(),kt(),Jt(),new MutationObserver(()=>{xt(),mt(),kt()}).observe(document.body,{childList:!0,subtree:!0}),document.addEventListener("keydown",t=>{t.ctrlKey&&t.shiftKey&&(t.key==="B"||t.key==="b")&&(t.preventDefault(),K())}),document.addEventListener("click",t=>{if(!W())return;let e=t.target;e instanceof Element&&(e.closest(`[${A}]`)||e.closest('[data-pane="sidebar"], [class*="sidebarCol"]')&&K(!1))});function re(){let t=ut();if(!t||t.clientWidth===0)return;let e=t.style.width;try{t.style.width=`${t.clientWidth-2}px`,setTimeout(()=>{t.style.width=e||"";try{window.dispatchEvent(new Event("resize"))}catch{}},180)}catch{}}try{localStorage.getItem("dsh-taskboard.unstick")!==null&&(localStorage.removeItem("dsh-taskboard.unstick"),setTimeout(()=>{Tt()},900),setTimeout(()=>{Tt()},2e3))}catch{}try{let t=localStorage.getItem("dsh-taskboard.pending-toast");t!==null&&(localStorage.removeItem("dsh-taskboard.pending-toast"),setTimeout(()=>{L(t)},1200))}catch{}let de=[400,1e3,2e3],jt=()=>{for(let t of de)setTimeout(re,t)};document.readyState==="loading"?window.addEventListener("load",jt):jt()})();})();
