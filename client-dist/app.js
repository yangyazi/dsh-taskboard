(()=>{(()=>{if(window.__dshTaskboardLoaded)return;window.__dshTaskboardLoaded=!0;let Rt="/taskboard/api",m={todo:{label:"\u5F85\u529E",color:"#8b949e"},in_progress:{label:"\u8FDB\u884C\u4E2D",color:"#3478f6"},in_review:{label:"\u8BC4\u5BA1\u4E2D",color:"#bc8cff"},blocked:{label:"\u5DF2\u963B\u585E",color:"#f85149"},done:{label:"\u5DF2\u5B8C\u6210",color:"#3fb950"}},R=["todo","in_progress","in_review","blocked","done"],D={low:{label:"\u4F4E",color:"#8b949e"},medium:{label:"\u4E2D",color:"#d29922"},high:{label:"\u9AD8",color:"#e3862e"},urgent:{label:"\u7D27\u6025",color:"#f85149"}},nt={none:"\u2014",pending:"\u8BC4\u5BA1\u5F85\u5904\u7406",approved:"\u8BC4\u5BA1\u901A\u8FC7",rejected:"\u8BC4\u5BA1\u9A73\u56DE"},rt={none:"\u2014",pending:"\u6D4B\u8BD5\u5F85\u5904\u7406",passed:"\u6D4B\u8BD5\u901A\u8FC7",failed:"\u6D4B\u8BD5\u5931\u8D25"},ut=["#79c0ff","#d2a8ff","#7ee787","#ffa657","#ff7b72","#f2cc60","#a5d6ff","#ffd7a8"],A="data-dsh-taskboard-active",M="data-dsh-taskboard-entry",P="data-dsh-taskboard-view",W="data-dsh-ssh-active",Dt='<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="2.5" width="12" height="11" rx="1.5"/><path d="M2 6.5h12M6.5 6.5v7"/></svg>',o=(t,e=document)=>e.querySelector(t),w=(t,e=document)=>[...e.querySelectorAll(t)],l=t=>String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]),q=t=>{let e=String(t||"").split("/").filter(Boolean);return e.length?e[e.length-1]:String(t||"")},qt=t=>{let e=0;for(let s of String(t))e=e*31+s.charCodeAt(0)>>>0;return ut[e%ut.length]},B=t=>{if(!t)return"";let e=new Date(t),s=Date.now()-t;return s<6e4?"\u521A\u521A":s<36e5?`${Math.floor(s/6e4)} \u5206\u949F\u524D`:s<864e5?`${Math.floor(s/36e5)} \u5C0F\u65F6\u524D`:`${e.getMonth()+1}/${e.getDate()} ${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`},I=[],_=[],J=[],it=[],z={q:"",repo:"",priority:"",status:"",label:""},N="overview",Z={};async function g(t,e={}){let s=await fetch(Rt+t,{headers:{"content-type":"application/json"},...e}),a=await s.json().catch(()=>({}));if(!s.ok)throw new Error(a.error||`HTTP ${s.status}`);return a}let Bt=`
<style>
...
<div id="dsh-tb-view" ${P}="">
  ...
  <div class="dsh-tb-body" id="dsh-tb-body"></div>
</div>`;function vt(){let t=document.querySelector('[data-pane="sidebar"], [class*="sidebarCol"]');return t===null?void 0:t.querySelector('[class*="logoRow"]')?.parentElement??t.firstElementChild}function gt(t){let e=t.querySelector('button[class*="newSession"]');if(e!==null)return e;for(let s of t.children)if(s.tagName==="BUTTON")return s}function xt(){return document.querySelector('[data-pane="conversation"]')??document.querySelector('[class*="centerCol"]')??void 0}function mt(t){return[...t.classList].some(e=>/collapsed/i.test(e))}let y=null,F=null;function U(){return document.documentElement.hasAttribute(A)}function wt(){y!==null&&(U()?y.setAttribute("data-active",""):y.removeAttribute("data-active"))}function X(t){let e=t!==void 0?t:!U();e&&document.documentElement.removeAttribute(W),e?document.documentElement.setAttribute(A,""):document.documentElement.removeAttribute(A),wt(),e&&G()}function yt(){if(F!==null)return;let t=xt();t!==void 0&&(F=document.createElement("div"),F.setAttribute(P,""),F.innerHTML=Jt,t.appendChild(F),Xt())}function $t(){let t=vt();if(t===void 0||(y===null&&(y=document.createElement("button"),y.type="button",y.setAttribute(M,""),y.innerHTML=`<span>${Dt}</span><span>\u4EFB\u52A1\u770B\u677F</span>`,y.title="\u4EFB\u52A1\u770B\u677F",y.addEventListener("click",()=>X()),wt()),y.parentElement===t))return;let e=gt(t),s=e?.closest('[class*="logoRow"]'),a=s!=null&&s.parentElement===t?s:e;t.insertBefore(y,a?.nextElementSibling??null),(()=>{y!==null&&(mt(t)?y.setAttribute("data-icon-only",""):y.removeAttribute("data-icon-only"))})()}let tt=15,kt="dsh-tb-recent-hidden",Et="dsh-tb-recent-expanded",S=!1,j=new Set;try{S=localStorage.getItem(Et)==="1",j=new Set(JSON.parse(localStorage.getItem(kt)||"[]"))}catch{}function St(){try{localStorage.setItem(kt,JSON.stringify([...j]))}catch{}}let x=null,$=null,Y=!1,Lt=null;function V(t){let e=String(t??"");return e&&!e.startsWith("session-")?`session-${e}`:e}function dt(t){return(t||[]).map(e=>e&&e.id&&V(e.id)!==e.id?{...e,id:V(e.id)}:e)}function Yt(){return g("/sessions").then(t=>dt(t.sessions||[])).catch(()=>_)}function lt(t){return t.title&&String(t.title).trim()?String(t.title).trim():String(t.id)}function Vt(t){return String(t).replace(/^session-/,"").slice(0,8)}function Tt(t){let e=new Set,s=[];for(let a of[...t||[]].filter(i=>i&&i.updatedAt).sort((i,c)=>(c.updatedAt||0)-(i.updatedAt||0)))if(!e.has(a.id)&&!(a.empty===!0||lt(a)===String(a.id))&&!j.has(a.id)&&(e.add(a.id),s.push(a),!S&&s.length>=tt))break;return s}function Kt(t){let e=S;S=!0;let s=Tt(t).length;return S=e,s}function Ct(t){return`dsh-tb-read:${t}`}function Wt(t){try{return Number(localStorage.getItem(Ct(t)))||0}catch{return 0}}function Ft(t){try{localStorage.setItem(Ct(t),String(Date.now()))}catch{}}function ct(t){if($===null)return;let e=Tt(t),s=Kt(t),a=o("#dsh-recent-cnt");a&&(a.textContent=S&&s>e.length?`${e.length}`:s>e.length?`${e.length}/${s}`:`${e.length}`);let i=o("#dsh-recent-more");i&&(i.style.display=s>tt?"":"none",i.textContent=S?`\u25B2 \u6536\u8D77\uFF08\u53EA\u770B ${tt} \u6761\uFF09`:`\u25BC \u5C55\u5F00\u5168\u90E8 ${s} \u6761`,i.title=S?`\u6536\u8D77\u4E3A\u6700\u8FD1 ${tt} \u6761`:`\u5C55\u5F00\u5168\u90E8 ${s} \u6761\uFF08\u53EF\u5728\u5217\u8868\u5185\u4E0A\u4E0B\u6EDA\u52A8\uFF09`,i.classList.toggle("open",S));let c=o("#dsh-recent-undo");if(c&&(c.style.display=j.size>0?"":"none",c.title=`\u6062\u590D ${j.size} \u6761\u88AB\u9690\u85CF\u7684\u5BF9\u8BDD`,c.textContent=`\u21BA${j.size}`),$.style.maxHeight=S?"72vh":"46vh",!e.length){$.innerHTML=`<div class="dsh-recent-empty">${j.size>0?"\uFF08\u90FD\u9690\u85CF\u4E86\uFF0C\u70B9 \u21BA \u6062\u590D\uFF09":"\uFF08\u6682\u65E0\u6700\u8FD1\u4F1A\u8BDD\uFF09"}</div>`;return}let b=et(),u=new Map;for(let d of e){let p=lt(d);u.set(p,(u.get(p)||0)+1)}$.innerHTML=e.map(d=>{let p=lt(d),n=(u.get(p)||0)>1,h=d.id===b,f="";return d.running?f='<span class="dot run"></span>':d.updatedAt&&d.updatedAt>Wt(d.id)&&(f='<span class="dot idle"></span>'),`<div class="dsh-recent-row${h?" cur":""}" data-sid="${l(d.id)}" title="\u6253\u5F00\u5E76\u7EE7\u7EED\uFF1A${l(p)}\uFF08${l(d.id)}\uFF09">
			...
			</div>`}).join(""),w(".dsh-recent-row",$).forEach(d=>d.addEventListener("click",()=>{st(d.dataset.sid)})),w(".dsh-recent-row .hide",$).forEach(d=>d.addEventListener("click",p=>{p.stopPropagation(),j.add(d.dataset.hide),St(),H(),L("\u5DF2\u4ECE\u300C\u6700\u65B0\u5BF9\u8BDD\u300D\u79FB\u9664\uFF08\u70B9 \u21BA \u53EF\u6062\u590D\uFF09")}))}function H(){Yt().then(t=>ct(t)).catch(()=>ct(_))}function zt(){let t=vt();if(t===void 0||(x===null&&(x=document.createElement("div"),x.id="dsh-recent",x.className="dsh-recent",x.innerHTML=`
				...
				<button class="dsh-recent-more" id="dsh-recent-more" style="display:none"></button>`,$=o("#dsh-recent-body",x),o("#dsh-recent-head",x).addEventListener("click",()=>{Y=!Y,x&&x.classList.toggle("collapsed",Y),$&&($.style.display=Y?"none":"")}),o("#dsh-recent-refresh",x).addEventListener("click",i=>{i.stopPropagation(),H()}),o("#dsh-recent-more",x).addEventListener("click",i=>{i.stopPropagation(),S=!S;try{localStorage.setItem(Et,S?"1":"0")}catch{}H()}),o("#dsh-recent-undo",x).addEventListener("click",i=>{i.stopPropagation();let c=j.size;j.clear(),St(),H(),L(`\u5DF2\u6062\u590D ${c} \u6761\u5BF9\u8BDD`)}),ct(_),H()),x.parentElement===t))return;let e=y??gt(t);t.insertBefore(x,e?.nextElementSibling??null),$&&($.style.maxHeight="46vh",$.style.overflowY="auto"),(()=>{$&&($.style.display=Y?"none":""),x&&x.classList.toggle("collapsed",Y)})(),(()=>{x&&(mt(t)?x.style.display="none":x.style.display="")})()}function Ut(){Lt===null&&(Lt=setInterval(()=>{document.hidden||H()},6e4))}function Xt(){o("#dsh-tb-new")?.addEventListener("click",Pt),o("#dsh-tb-refresh")?.addEventListener("click",()=>G()),o("#dsh-tb-search")?.addEventListener("input",()=>{z.q=o("#dsh-tb-search").value.trim(),k()}),o("#dsh-tb-repo-filter")?.addEventListener("change",()=>{z.repo=o("#dsh-tb-repo-filter").value,k()}),o("#dsh-tb-priority-filter")?.addEventListener("change",()=>{z.priority=o("#dsh-tb-priority-filter").value,k()}),o("#dsh-tb-status-filter")?.addEventListener("change",()=>{z.status=o("#dsh-tb-status-filter").value,k()}),o("#dsh-tb-label-filter")?.addEventListener("change",()=>{z.label=o("#dsh-tb-label-filter").value,k()}),w(".dsh-tb-tab").forEach(t=>t.addEventListener("click",()=>{N=t.dataset.tbView,at()}))}async function k(){let t=new URLSearchParams;for(let s of["q","repo","priority","status","label"])z[s]&&t.set(s,z[s]);I=(await g(`/tasks?${t}`)).tasks||[],at()}async function Gt(){try{let[t,e]=await Promise.all([g("/sessions"),g("/workspaces")]);_=dt(t.sessions||[]),J=e.workspaces||[];let s=o("#dsh-tb-repo-filter");if(s){let d=s.value;s.innerHTML='<option value="">\u5168\u90E8\u4ED3\u5E93</option>'+J.map(p=>`<option value="${l(p.path)}" title="${l(p.path)}">${l(q(p.path))}</option>`).join(""),d&&[...s.options].some(p=>p.value===d)&&(s.value=d)}let a=await g("/tasks").catch(()=>({tasks:[]})),i=new Set;for(let d of a.tasks||[])for(let p of d.labels||[])i.add(p);it=[...i].sort();let c=o("#dsh-tb-label-filter");if(c){let d=c.value;c.innerHTML='<option value="">\u5168\u90E8\u6807\u7B7E</option>'+it.map(p=>`<option value="${l(p)}">${l(p)}</option>`).join(""),d&&[...c.options].some(p=>p.value===d)&&(c.value=d)}let b=o("#dsh-tb-priority-filter");b&&!b.options.length&&(b.innerHTML='<option value="">\u5168\u90E8\u4F18\u5148\u7EA7</option>'+Object.entries(D).map(([d,p])=>`<option value="${d}">${p.label}</option>`).join(""));let u=o("#dsh-tb-status-filter");u&&!u.options.length&&(u.innerHTML='<option value="">\u5168\u90E8\u72B6\u6001</option>'+Object.entries(m).map(([d,p])=>`<option value="${d}">${p.label}</option>`).join(""))}catch{}}async function Qt(){for(let t of J)if(!(!t.path||Z[t.path]!==void 0))try{let e=await fetch(`/ide/api/git?op=status&path=${encodeURIComponent(t.path)}`).then(s=>s.json());Z[t.path]=e.git?{branch:e.branch?.name||"(detached)",dirty:(e.files||[]).length}:null}catch{Z[t.path]=null}}function G(){return Gt().then(()=>Qt()).then(k).catch(k)}function jt(t){return(t.labels||[]).map(e=>`<span class="dsh-tb-pill" style="color:${qt(e)}">${l(e)}</span>`).join("")}function Zt(t){let e=m[t.status]||m.todo;return`<span class="dsh-tb-pill" style="color:${e.color}">${e.label}</span>`}function At(t){let e=D[t.priority]||D.medium;return`<span class="dsh-tb-pill" style="color:${e.color}">${e.label}</span>`}function te(t){let e=(s,a,i)=>`<button type="button" class="dsh-tb-statusbtn ${i||""}" data-status="${s}">${a}</button>`;switch(t.status){case"todo":return`${e("in_progress","\u25B6 \u5F00\u59CB\u6267\u884C")} ${e("blocked","\u26D4 \u963B\u585E","ghost")}`;case"in_progress":return`${e("in_review","\u63D0\u4EA4\u8BC4\u5BA1")} ${e("blocked","\u26D4 \u963B\u585E","ghost")}`;case"in_review":return`${e("done","\u2705 \u786E\u8BA4\u5B8C\u6210","primary")} ${e("in_progress","\u21A9 \u9000\u56DE\u4FEE\u6539")}`;case"done":return`${e("in_progress","\u21A9 \u91CD\u65B0\u6253\u5F00","ghost")}`;case"blocked":return`${e("in_progress","\u25B6 \u6062\u590D\u8FDB\u884C")}`;default:return""}}let bt=null,It=0,ee=5e3;function se(){let t=new Set,e=document.querySelectorAll('[class*="centerCol"], [class*="sidebarCol"], [class*="frame"], [class*="App"], body > div');for(let s of e){for(let a of Object.keys(s)){if(!a.startsWith("__reactFiber$")&&!a.startsWith("__reactContainer$"))continue;let i=s[a];for(;i&&i.return;)i=i.return;i&&t.add(i)}if(t.size>0)break}return[...t]}function Mt(){let t=Date.now();if(bt!==null&&t-It<ee)return bt;let e={open:null,startSession:null},s=se(),a=0,i=t+40;for(;s.length>0&&a++<4e4&&!((a&255)===0&&Date.now()>i);){let c=s.shift(),b=c.memoizedProps;if(b!==null&&typeof b=="object"){e.open===null&&typeof b.open=="function"&&(e.open=b.open),e.startSession===null&&typeof b.startSession=="function"&&(e.startSession=b.startSession);let u=b.sessions??b.sessionService;if(u!==null&&typeof u=="object"&&(e.open===null&&typeof u.open=="function"&&(e.open=u.open),e.startSession===null&&typeof u.start=="function"&&(e.startSession=u.start)),e.open!==null&&e.startSession!==null)break}c.child&&s.push(c.child),c.sibling&&s.push(c.sibling)}return bt=e,It=Date.now(),e}function ae(){return Mt().open}function et(){try{let t=localStorage.getItem("dsh.sessions.current");if(t===null)return null;let e=JSON.parse(t);return typeof e?.sessionId=="string"?e.sessionId:null}catch{return null}}function _t(){let t=[...document.querySelectorAll('[class*="_handle"], [class*="handle"]')].find(d=>d.offsetParent!==null&&getComputedStyle(d).cursor==="col-resize");if(!t)return!1;let e=t.getBoundingClientRect(),s=Math.round(e.left+e.width/2),a=Math.round(e.top+Math.min(200,e.height/2)),i=Element.prototype,c=i.setPointerCapture,b=i.hasPointerCapture,u=i.releasePointerCapture;try{i.setPointerCapture=function(){},i.hasPointerCapture=function(){return!0},i.releasePointerCapture=function(){};let d=(p,n)=>new PointerEvent(p,{bubbles:!0,cancelable:!0,composed:!0,pointerId:1,pointerType:"mouse",isPrimary:!0,buttons:1,clientX:n,clientY:a});return t.dispatchEvent(d("pointerdown",s)),t.dispatchEvent(d("pointermove",s+1)),t.dispatchEvent(d("pointerup",s+1)),!0}catch{return!1}finally{i.setPointerCapture=c,i.hasPointerCapture=b,i.releasePointerCapture=u}}function st(t){t=V(t),Ft(t);try{let e=ae();if(typeof e=="function"){try{localStorage.setItem("dsh.sessions.current",JSON.stringify({sessionId:t}))}catch{}e(t),U()&&X(!1),w(".dsh-tb-modal-mask").forEach(s=>s.remove()),H();return}}catch{}try{localStorage.setItem("dsh.sessions.current",JSON.stringify({sessionId:t})),localStorage.setItem("dsh-taskboard.unstick",String(Date.now()))}catch{}location.reload()}async function Ot(t){let e=et(),s=new Set;try{s=new Set((await g("/sessions")).sessions.map(a=>V(a.id)))}catch{}if(oe())return U()&&X(!1),w(".dsh-tb-modal-mask").forEach(a=>a.remove()),ne(t),L("\u5DF2\u8FDB\u5165\u65B0\u5BF9\u8BDD\uFF1A\u53D1\u9001\u7B2C\u4E00\u6761\u6D88\u606F\u540E\u81EA\u52A8\u7ED1\u5B9A\u5230\u8BE5\u4EFB\u52A1"),re(t,e,s),!0;try{let{sessionId:a}=await g(`/tasks/${t}/session`,{method:"POST",body:"{}"});return ie("\u2713 \u5DF2\u65B0\u5EFA\u5BF9\u8BDD\u5E76\u7ED1\u5B9A\u5230\u8BE5\u4EFB\u52A1"),st(a),!0}catch(a){return alert(`\u65B0\u5EFA\u5BF9\u8BDD\u5931\u8D25\uFF1A${a.message}`),!1}}function oe(){let t=document.querySelector('button[class*="newSession"]');if(t!==null)return t.click(),!0;let e=Mt();if(typeof e.startSession=="function")try{return e.startSession(),!0}catch{}return!1}function ne(t){g(`/tasks/${t}/context`).then(e=>{let s=e?.context;if(!(typeof s!="string"||!s))return navigator.clipboard?.writeText?.(s)}).catch(()=>{})}function re(t,e,s){let a=Date.now()+18e5,i=setInterval(async()=>{let c=et();if(c!==null&&c!==e&&!s.has(c)){clearInterval(i);try{await g(`/tasks/${t}/sessions`,{method:"POST",body:JSON.stringify({sessionId:c,action:"link"})}),L("\u2713 \u5DF2\u628A\u65B0\u5BF9\u8BDD\u7ED1\u5B9A\u5230\u8BE5\u4EFB\u52A1"),k()}catch{}return}Date.now()>a&&clearInterval(i)},1e3)}function ie(t){try{localStorage.setItem("dsh-taskboard.pending-toast",t)}catch{}}function L(t){let e=document.createElement("div");e.className="dsh-tb-toast",e.textContent=t,document.body.appendChild(e),setTimeout(()=>e.remove(),1600)}function de(){var f;let t={};for(let r of R)t[r]=0;let e={};for(let r of I){t[r.status]!==void 0&&t[r.status]++;let v=r.repo||"\uFF08\u672A\u6307\u5B9A\uFF09";(e[v]||(e[v]=[])).push(r)}let s=I.length,a=t.done||0,i=s?Math.round(a/s*100):0,c={};for(let r of _)r.repo&&(c[f=r.repo]||(c[f]=[])).push(r);let b=[...I].sort((r,v)=>v.updatedAt-r.updatedAt).slice(0,10),d='<div class="dsh-tb-ov-stat dsh-tb-ov-add" id="dsh-tb-ov-new" title="\u65B0\u5EFA\u4EFB\u52A1"><div class="dsh-tb-ov-addbtn">\uFF0B \u65B0\u5EFA\u4EFB\u52A1</div></div>'+[["\u5168\u90E8\u4EFB\u52A1",s,"#e6edf3",""],...R.map(r=>[m[r].label,t[r]||0,m[r].color,r]),["\u5B8C\u6210\u7387",`${i}%`,"#3fb950",null]].map(([r,v,T,E])=>{let ht=r==="\u5B8C\u6210\u7387"?i:s?Math.round(v/s*100):0,ot=E!==null?" dsh-tb-ov-stat-click":"",ft=E===""?"\u67E5\u770B\u5168\u90E8\u4EFB\u52A1":E?`\u67E5\u770B\u300C${r}\u300D\u7684\u4EFB\u52A1`:"";return`<div class="dsh-tb-ov-stat${ot}" ${E!==null?`data-status="${E}"`:""} title="${ft}"><div class="n" style="color:${T}">${v}</div><div class="l">${r}</div><div class="mini"><i style="width:${ht}%;background:${T}"></i></div></div>`}).join(""),p;J.length?p=J.map(r=>{let v=e[r.path]||e[r.title]||[],T=R.map(C=>v.filter(O=>O.status===C).length),E=v.length,ht=T[R.indexOf("done")]||0,ot=E?Math.round(ht/E*100):0,ft=E?R.map((C,O)=>T[O]?`<i style="width:${Math.round(T[O]/E*100)}%;background:${m[C].color}" title="${m[C].label} ${T[O]}"></i>`:"").join(""):"",ue=R.map((C,O)=>T[O]?`<span class="st"><i class="dot" style="background:${m[C].color}"></i>${m[C].label} <b>${T[O]}</b></span>`:"").join(""),ve=(c[r.path]||c[r.title]||[]).length,Q=Z[r.path],ge=Q?`<span class="branch">\u2387 ${l(Q.branch)}</span>${Q.dirty?`<span class="branch dirty" title="${Q.dirty} \u4E2A\u672A\u63D0\u4EA4\u6587\u4EF6">\u25CF${Q.dirty}</span>`:""}`:"",Ht=(c[r.path]||c[r.title]||[]).slice(0,3).map(C=>`<div class="s" data-sid="${l(C.id)}" title="\u6253\u5F00\u4F1A\u8BDD ${l(C.id)}">\u25B8 ${l(C.title)}</div>`).join("");return`<div class="dsh-tb-ov-ws" data-repo="${l(r.path)}">
					...
					<div class="comp"><span class="pct">\u5B8C\u6210\u7387 ${ot}%</span><div class="track"><i style="width:${ot}%"></i></div></div>
					<div class="meta">${ge}<span class="sess">\u4F1A\u8BDD ${ve}</span></div>
					${Ht?`<div class="sesslist">${Ht}</div>`:""}
				</div>`}).join(""):p='<div class="dsh-tb-empty">\uFF08\u6682\u65E0\u5DE5\u4F5C\u533A\uFF09</div>';let n=b.length?b.map(r=>{let v=m[r.status]||m.todo;return`<div class="dsh-tb-ov-item" data-id="${l(r.id)}">
		...
		</div>`,o("#dsh-tb-ov-new")?.addEventListener("click",Pt),w(".dsh-tb-ov-stat[data-status]").forEach(r=>r.addEventListener("click",()=>{z.status=r.dataset.status,N="list",at(),k()})),w(".dsh-tb-ov-ws").forEach(r=>r.addEventListener("click",()=>{z.repo=r.dataset.repo;let v=o("#dsh-tb-repo-filter");v&&(v.value=z.repo),N="kanban",at(),k()})),w(".dsh-tb-ov-ws .s").forEach(r=>r.addEventListener("click",v=>{v.stopPropagation(),st(r.dataset.sid)})),w(".dsh-tb-ov-item").forEach(r=>r.addEventListener("click",()=>{r.dataset.id&&K(r.dataset.id)})))}function le(t){let e=m[t.status]||m.todo,s=D[t.priority]||D.medium,a=[];a.push(At(t)),t.status==="in_review"&&a.push('<span class="dsh-tb-pill" style="color:#bc8cff;font-weight:600">\u25C9 \u5F85 review</span>'),t.repo&&a.push(`<span class="dsh-tb-pill" style="color:#79c0ff">${l(q(t.repo))}</span>`),t.feature&&a.push(`<span class="dsh-tb-pill" style="color:#d2a8ff">${l(t.feature)}</span>`),a.push(jt(t)),t.review&&t.review!=="none"&&a.push(`<span class="dsh-tb-pill" style="color:${t.review==="approved"?"#3fb950":t.review==="rejected"?"#f85149":"#d29922"}">${nt[t.review]}</span>`),t.test&&t.test!=="none"&&a.push(`<span class="dsh-tb-pill" style="color:${t.test==="passed"?"#3fb950":t.test==="failed"?"#f85149":"#d29922"}">${rt[t.test]}</span>`);let i=[];return t.sessionIds?.length&&i.push(`<span>\u4F1A\u8BDD ${t.sessionIds.length}</span>`),t.notes?.length&&i.push(`<span>\u8BC4\u8BBA ${t.notes.length}</span>`),i.push(`<span>${B(t.updatedAt)}</span>`),`<div class="dsh-tb-card" data-id="${l(t.id)}" style="border-left:3px solid ${e.color}">
			...
			<td>${a.review!=="none"?`<span class="dsh-tb-pill" style="color:${a.review==="approved"?"#3fb950":a.review==="rejected"?"#f85149":"#d29922"}">${nt[a.review]}</span>`:""}</td>
			<td>${a.test!=="none"?`<span class="dsh-tb-pill" style="color:${a.test==="passed"?"#3fb950":a.test==="failed"?"#f85149":"#d29922"}">${rt[a.test]}</span>`:""}</td>
			...
			<div class="dsh-tb-row">
				<div class="dsh-tb-field"><label>Review</label><select id="tb-d-review">${Object.entries(nt).map(([n,h])=>`<option value="${n}" ${n===t.review?"selected":""}>${h}</option>`).join("")}</select></div>
				<div class="dsh-tb-field"><label>\u6D4B\u8BD5</label><select id="tb-d-test">${Object.entries(rt).map(([n,h])=>`<option value="${n}" ${n===t.test?"selected":""}>${h}</option>`).join("")}</select></div>
				<div class="dsh-tb-field"><label>\u6807\u7B7E</label><input id="tb-d-labels" value="${l((t.labels||[]).join(", "))}" placeholder="\u9017\u53F7\u5206\u9694" list="tb-labels-datalist2" /><datalist id="tb-labels-datalist2">${it.map(n=>`<option value="${l(n)}"></option>`).join("")}</datalist></div>
			</div>
